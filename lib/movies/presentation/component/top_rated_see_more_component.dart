...
class TopRatedSeeMoreComponent extends StatelessWidget {
  const TopRatedSeeMoreComponent({
    super.key,
          ...
          children: [
            ClipRRect(
              ...
              child: CachedNetworkImage(
                ...
                height: 140.0,
                fit: BoxFit.cover,
                imageUrl: ApiConstance.imageUrl(topRatedMovies.backdropPath),
                    ...
                    children: [
                      ...
                      Row(children: [
                        Container(
                          ...
                          child: Text(
                            topRatedMovies.releaseDate.split('-')[0],
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              (topRatedMovies.voteAverage).toStringAsFixed(1),
                              style: const TextStyle(
                                fontSize: 12.0,
                                fontWeight: FontWeight.w500,
                                letterSpacing: 1.2,
